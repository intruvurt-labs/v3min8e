...
const dailyRewards: DailyReward[] = [
  { day: 1, type: "tokens", amount: 100, rarity: "common", title: "Welcome Tokens", description: "100 VERM tokens", claimed: false, icon: <Coins className="w-6 h-6" /> },
  { day: 2, type: "xp", amount: 50, rarity: "common", title: "Knowledge Boost", description: "50 XP points", claimed: false, icon: <Star className="w-6 h-6" /> },
  { day: 3, type: "tokens", amount: 200, rarity: "rare", title: "Token Haul", description: "200 VERM tokens", claimed: false, icon: <Coins className="w-6 h-6" /> },
  { day: 4, type: "multiplier", amount: 2, rarity: "rare", title: "Scan Multiplier", description: "2x scan rewards for 24h", claimed: false, icon: <Zap className="w-6 h-6" /> },
  { day: 5, type: "xp", amount: 100, rarity: "epic", title: "XP Surge", description: "100 XP points", claimed: false, icon: <TrendingUp className="w-6 h-6" /> },
  { day: 6, type: "tokens", amount: 500, rarity: "epic", title: "Token Bonanza", description: "500 VERM tokens", claimed: false, icon: <Trophy className="w-6 h-6" /> },
  { day: 7, type: "nft", amount: 1, rarity: "legendary", title: "Ghost Badge NFT", description: "Exclusive Data Ghost NFT", claimed: false, icon: <Crown className="w-6 h-6" /> },
];
...
export default function DailyRewardsSystem() {
  ...
  const getCurrentDay = () => {
    const lastClaim = userProgress.lastClaimDate ? new Date(userProgress.lastClaimDate) : null;
    const today = new Date();
    const diffTime = lastClaim ? Math.abs(today.getTime() - lastClaim.getTime()) : 0;
      ...
      <div className="bg-gradient-to-r from-dark-bg/90 to-darker-bg/90 border border-cyber-green/30 rounded-2xl p-6 backdrop-blur-xl">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-xl font-cyber font-bold text-cyber-green">DATA GHOST</h3>
          ...
          {rewards.map((reward) => (
            ...
            >
              ...
              `}>
                ...
                {reward.day === currentDay && canClaimToday && !reward.claimed && (
          ...
          <div className="mt-6 p-4 bg-cyber-purple/10 border border-cyber-purple/30 rounded-lg">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-sm font-bold text-cyber-purple">Tomorrow's Reward</div>
                  <div className="text-xs text-gray-300">{rewards[currentDay]?.title}</div>
                </div>
              </div>
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="flex items-center justify-center gap-2 text-cyber-green">
                  ...
                  <span className="font-bold">+{selectedReward.type === "xp" ? selectedReward.amount + " XP" : "Reward Added"}</span>
                  <Star className="w-5 h-5" />
                </div>
